                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(
                          backgroundImage: _image == null ? NetworkImage(user.image) : FileImage(File(_image.path)),
                          radius: 60,
                        ),
                      ),
                      Padding(
                      ...
                      ListTile(
                        title: Text('Full Name', style: Theme.of(context).textTheme.headline6),
                      ...
                      ListTile(
                        title: Text('Mobile Number', style: Theme.of(context).textTheme.headline6),
                      ...
                      ListTile(
                        title: Text('Your Address', style: Theme.of(context).textTheme.headline6),
                        subtitle: Text(user.address),
                      ),
                      ListTile(
                        title: Text('Barangay', style: Theme.of(context).textTheme.headline6),
                        subtitle: Text(user.city),
                      ),
                      ListTile(
                        title: Text('Province', style: Theme.of(context).textTheme.headline6),
