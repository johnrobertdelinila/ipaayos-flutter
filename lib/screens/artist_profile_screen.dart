...
class _ArtistProfileScreenState extends State<ArtistProfileScreen>
  ...
  void didChangeDependencies() {
    if (isInit) {
      Provider.of<Auth>(context, listen: false).getArtistInfo(Global.currentUID.toString()).then((value) {
        setState(() {
          isInit = false;
        });
      });
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (ctx) => EditArtistProfileScreen(
                                      ...
                                      lati: artist.latitude != null ? double.parse(artist.latitude) : 0.0,
                                      longi: artist.longitude != null ? double.parse(artist.longitude) : 0.0,
                                      name: artist.name ?? '',
                                      rate: artist.price ?? '',
