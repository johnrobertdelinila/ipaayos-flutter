...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _showRegisteredDialog(String message) async {
    await showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text('Registration almost done!'),
        content: Text(message),
        actions: <Widget>[
          FlatButton(
            onPressed: () {
  ...
  Future<void> _submit(BuildContext ctx) async {
    ...
    await _showRegisteredDialog('Please check your email to complete the registration!');
    setState(() {
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                icon: Icon(
                                  _visibilityConfirm ? Icons.visibility : Icons.visibility_off,
                                  color: Theme.of(context).primaryColor,
                                ),
                                onPressed: () {
                                  setState(() {
