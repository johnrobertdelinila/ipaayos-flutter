...
class ArtistProfileInfoWidget extends StatefulWidget {
  ...
  @override
  _ArtistProfileInfoWidgetState createState() => _ArtistProfileInfoWidgetState();
}
          ...
          children: [
                      ...
                      children: [
                        WidgetSpan(
                          child: StarRatingWidget(
                            color: Colors.yellow,
                            rating: artist.avaRating != null ? artist.avaRating.toDouble() : 0.0,
                          ),
                        ),
                        TextSpan(
                          text: '(${artist.avaRating ?? 1}/5)',
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: '${artist.jobDone ?? '0'} Jobs Completed',
                        style: Theme.of(context).textTheme.headline6.copyWith(
                              fontSize: 16,
                            ),
                      ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: '${artist.percentages ?? '0'}% Completion',
                        style: Theme.of(context).textTheme.headline6.copyWith(
                              fontSize: 16,
                            ),
                      ),
            ...
            ListTile(
              ...
              trailing: GestureDetector(
                onTap: () {
                  Provider.of<Auth>(context, listen: false).changeArtistRateType(artist.commissionType == '0' ? '1' : '0');
                },
                child: Container(
                                      ...
                                      onTap: () {
                                        showDialog(
                                          ...
                                          builder: (context) => new AlertDialog(
                                            title: new Text('Ipaayos Service App?'),
                                            ...
                                            actions: <Widget>[
                                              ...
                                              new FlatButton(
                                                onPressed: () {
                                                  ...
                                                  Provider.of<Auth>(context, listen: false).deleteQualification(item['id']);
                                                },
                                                child: new Text('Yes'),
                                              ),
                                            ],
                ...
                onPressed: () {
                  ...
                  Provider.of<Auth>(context, listen: false)
                    ...
                    gender,
                      ...
                      .then((value) {
                        /*
                    if (_oldPhone != _mobileController.text) {
